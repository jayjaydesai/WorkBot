...
base_path = os.getenv("BASE_UPLOAD_PATH", os.path.join("C:", os.sep, "Users", "jaydi", "OneDrive - Comline", "CAPLOCATION", "Deployment", "bulk_report_webapp", "output", "GREPLEN"))
input_file = os.path.join(base_path, "OUTPUT25.csv")
output_file = os.path.join(base_path, "WORKING.xlsx")
...
for row in sheet.iter_rows(min_row=2, max_row=sheet.max_row, min_col=21, max_col=21):  # NOTE column is column U (21st column)
    cell = row[0]
