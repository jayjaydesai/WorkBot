...
def create_output27(input_file, output_file):
    """
    Add border formatting, rename columns, and apply enhancements to OUTPUT26.xlsx.

    Args:
        input_file (str): Path to the input file (e.g., OUTPUT26.xlsx).
        output_file (str): Path to save the output file (e.g., OUTPUT27.xlsx).
    """
    try:
        ...
        column_rename_map = {
            ...
            "Rsubrange": "Subrange",
            "Posted Quantity": "Pallet Quantity",
            "Stock": "Export Stock",
            "Final Replen Stock": "Stock For Replen",
        }
        ...
        print(f"OUTPUT27.xlsx created and formatted at {output_file}")
...
def apply_formatting(output_file):
    """
    Apply formatting, including borders, to the Excel file (OUTPUT27.xlsx).
    ...
    print("Applying data cell formatting...")
...
if __name__ == "__main__":
    ...
    input_file = base_path / "output" / "REPLEN" / "OUTPUT26.xlsx"
    output_file = base_path / "output" / "REPLEN" / "OUTPUT27.xlsx"

    # Run the function
    create_output27(input_file, output_file)
