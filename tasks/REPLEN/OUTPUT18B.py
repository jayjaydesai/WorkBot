...
output18b_path = r"C:\Users\jayde\OneDrive\AS-REPLEN-DAILY\FINAL FILES TO SEND TO ROBERT\REPLAN_FORMAT_" + datetime.now().strftime('%Y-%m-%d') + ".xlsx"
...
column_order = [
    ...
    'FINAL STOCK FOR REPLEN', 'SUB RANGE', 'LEVEL STATUS'
]
renamed_columns = {
...
# Step 3: Function to format each sheet
def format_sheet(ws):
...
# Save the workbook
wb.save(output18b_path)
print(f"Workbook saved with three sheets at: {output18b_path}")
